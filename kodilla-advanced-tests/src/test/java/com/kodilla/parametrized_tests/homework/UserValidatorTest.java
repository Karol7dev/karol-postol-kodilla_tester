...
class UserValidatorTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"test@gmail.com","test.afterdot@gmail.com","student01@bbk.ac.uk","_123-test@mail.subdomain.company.com"})
    ...
    @ParameterizedTest
    @NullAndEmptySource
    public void shouldReturnFalseIfEmptyString(String value){
        assertFalse(validator.validateEmail(value));
    }
}