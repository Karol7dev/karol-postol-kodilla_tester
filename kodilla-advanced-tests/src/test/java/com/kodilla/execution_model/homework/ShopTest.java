...
class ShopTestSuite {
    ...
    // order year can be between 1950 and current year
    @Test
    public void shouldNotAllowToAddOrderWithIncorrectDateAndThrowAndException() {
        ...
        Assertions.assertThrows(IncorrectOrderException.class, () -> {
            shop.addOrder(new Order(1900, LocalDate.of(1900, 01, 20), "adam123"));
        });
    }

    // Testing order search by date range
    @Test
